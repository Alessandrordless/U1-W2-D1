...
// Esercizio 5 spostato a fine pagine per motivi di carattere tecnico
...
const rule1 = `invariabile`;
rule1 = `variabile`;
console.log(rule1);
//il valore della variabile costante non può essere alterato guarda errore console
